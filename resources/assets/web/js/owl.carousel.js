...
;(function($, window, document, undefined) {
	...
	Navigation.Defaults = {
		...
		navClass: [ 'owl-prev fa fa-angle-left border_vibrant text_vibrant text_vibrant_hover', 'owl-next border_vibrant text_vibrant text_vibrant_hover fa fa-angle-right' ],
		slideBy: 1,
		dotClass: 'owl-dot',
		dotsClass: 'owl-dots',
		dots: true,
