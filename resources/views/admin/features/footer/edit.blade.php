        ...
        <div class="row">
            <div class="col-xs-12">
                <div class="box box-primary">
                    ...
                    <form role="form" action="{{route('admin.links.update', ['feature'=>$feature->id, 'id' => $link->id])}}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="col-md-6">
                                <div class="form-group {{ $errors->has('parent_id') ? ' has-error' : '' }}">
                                    ...
                                    <select class="form-control" id="parent_id" name="parent_id" style="width: 100%;">
                                        <option value="0">@lang('admin.parent')</option>
