...
@if($feature->parallax()->count() >= 3)
    <section class="parallax  justify-content-center d-flex align-items-center" id="third_parallax"
             style="background-image: url({{ asset($link->image) }});">
        <div class="row">
            <div class="col-12">
