<section id="contents-page">
    <div class="container">
                ...
                <div class="wp-page mb-3">
                    ...
                    <div class="editor">
                        <table class="table table-striped table-hover table-bordered">
                            <thead class="bg_vibrant text_bg_vibrant ">
                            <tr>
                                <th scope="col">#</th>
        ...
        <div class="video mb-3">
            ...
            <div class="row">
                @for($i=0;$i<8;$i++)
                    <div class="col-12 col-xs-6 col-sm-4 col-md-3 col- mb-4">
        ...
        <div class="comment mb-3">
            <div class="row">
                <h2 class="title border_vibrant">@lang('web.comment')</h2>
                <!-- Button trigger modal -->
                <button type="button" class="btn-modal border_vibrant" data-toggle="modal" data-target="#comment-modal">
